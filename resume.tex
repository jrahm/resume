...
\begin{tikzpicture}[<->]
    ...
    \begin{scope}[x={(namesection.south east)},y={(namesection.north west)}]
        \draw[-, line width=0.1em, color=topheadings] (0.95, 0) -- (0.95, 1);
        \draw[-{Stealth[scale=2, length=4, width=4]}, line width=0.1em, color=topheadings] (0.95, 1) -- (0.95, 0.99);
        \draw[-, line width=0.1em, color=topheadings] ({0.5em + 10pt}, -10pt) -- (0.85, -10pt);
        \draw[-, line width=0.1em, color=topheadings] (0.85,-10pt) arc (-90:0:0.10);
...
\descript{| Hacking Grader \& Research Assistant}
