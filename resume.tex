...
\begin{textblock}{2}[0.5,0.5](27,7)
\includegraphics[width=45px]{bird.png}
\end{textblock}
% \begin{textblock}{2}[0.5,0.5](65,7)
% \includegraphics[width=45px]{bird_left.png}
% \end{textblock}
\lastupdated % Print the Last Updated text at the top right

\namesection{Josh}{Rahm}{ % Your name
joshuarahm@gmail.com | (720)-243-2230 \\ % Your contact information
1953 Goss St. Apt. \#4, Boulder, CO 80302
}
...
\location{May 2015 - August 2015 | Longmont, CO}
